...
impl LinuxClient for HeadlessClient {
    ...
    fn open_window(
        &self, _handle: AnyWindowHandle, _params: WindowParams,
    ...
    fn write_to_primary(&self, _item: gpuim::ClipboardItem) {}

    fn write_to_clipboard(&self, _item: gpuim::ClipboardItem) {}
