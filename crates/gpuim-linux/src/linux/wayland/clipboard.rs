...
use gpuim::{ClipboardEntry, ClipboardItem, Image, ImageFormat, hash};
...
#[derive(Clone, Debug)]
/// Wrapper for `WlDataOffer` and `ZwpPrimarySelectionOfferV1`, used to help
/// track mime types.
...
impl Clipboard {
    pub fn new(
        connection: Connection, loop_handle: LoopHandle<'static, WaylandClientStatePtr>,
    ) -> Self {
        Self {
            connection,
            loop_handle,
