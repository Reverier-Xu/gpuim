...
use gpuim_wgpu::WgpuContext;

use crate::{
    dispatcher::WebDispatcher, display::WebDisplay, keyboard::WebKeyboardLayout, window::WebWindow,
};
...
impl WebPlatform {
    pub fn new(allow_multi_threading: bool) -> Self {
        ...
        let text_system = Arc::new(gpuim_wgpu::CosmicTextSystem::new_without_system_fonts(
            "IBM Plex Sans",
        ));
