...
impl WindowsDispatcher {
    pub(crate) fn new(
        main_sender: PriorityQueueSender<RunnableVariant>, platform_window_handle: HWND,
        validation_number: usize,
    ) -> Self {
    ...
    fn dispatch_on_threadpool(&self, priority: WorkItemPriority, runnable: RunnableVariant) {
        let handler = {
            let task_wrapper = Cell::new(Some(runnable));
    ...
    pub(crate) fn execute_runnable(runnable: RunnableVariant) {
        ...
        gpuim::profiler::add_task_timing(timing);
