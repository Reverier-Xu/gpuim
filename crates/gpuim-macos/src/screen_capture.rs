...
impl ScreenCaptureSource for MacScreenCaptureSource {
    ...
    fn stream(
        ...
        unsafe {
            ...
            // Stream contains filter, configuration, and delegate internally so we release
            // them here to prevent a memory leak when steam is dropped
...
extern "C" fn stream_did_output_sample_buffer_of_type(
    this: &Object, _: Sel, _stream: id, sample_buffer: id, buffer_type: NSInteger,
) {
