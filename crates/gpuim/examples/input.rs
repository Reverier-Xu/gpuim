...
impl TextInput {
    ...
    fn on_mouse_down(
        &mut self, event: &MouseDownEvent, _window: &mut Window, cx: &mut Context<Self>,
    ) {
...
impl EntityInputHandler for TextInput {
    ...
    fn replace_and_mark_text_in_range(
        ...
        new_selected_range_utf16: Option<Range<usize>>, _window: &mut Window,
        cx: &mut Context<Self>,
    ) {
        let range = range_utf16
            .as_ref()
    ...
    fn character_index_for_point(
        &mut self, point: gpuim::Point<Pixels>, _window: &mut Window, _cx: &mut Context<Self>,
    ) -> Option<usize> {
...
impl Element for TextElement {
    ...
    fn request_layout(
        ...
        _inspector_id: Option<&gpuim::InspectorElementId>, window: &mut Window, cx: &mut App,
    ...
    fn prepaint(
        &mut self, _id: Option<&GlobalElementId>,
        _inspector_id: Option<&gpuim::InspectorElementId>, bounds: Bounds<Pixels>,
    ...
    fn paint(
        &mut self, _id: Option<&GlobalElementId>,
        _inspector_id: Option<&gpuim::InspectorElementId>, bounds: Bounds<Pixels>,
        _request_layout: &mut Self::RequestLayoutState, prepaint: &mut Self::PrepaintState,
