    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        fn button_base(id: impl Into<ElementId>, label: &'static str) -> Stateful<Div> {
            div()
                ...
                .justify_center()
                .items_center()
                .bg(gpuim::rgb(0x2563EB))
                .text_color(gpuim::white())
                .rounded_md()
                .cursor_pointer()
                .hover(|style| style.bg(gpuim::rgb(0x1D4ED8)))
                .child(label)
        }
        ...
        div()
            ...
            .p_8()
            .gap_6()
            .bg(gpuim::rgb(0xF3F4F6))
            .child(
                div()
                    .text_2xl()
                    .font_weight(gpuim::FontWeight::BOLD)
                    .text_color(gpuim::rgb(0x111827))
            ...
            .child(
                div()
                    .p_4()
                    .rounded_md()
                    .bg(gpuim::rgb(0xDBEAFE))
                    .text_color(gpuim::rgb(0x1E3A8A))
                        ...
                        div()
                            ...
                            .child(
                                button_base("button1", self.items[0].1)
                                    ...
                                    .focus(|style| {
                                        style.border_4().border_color(gpuim::rgb(0xFBBF24))
                                    })
                        ...
                        div()
                            ...
                            .child(
                                button_base("button2", self.items[1].1)
                                    ...
                                    .focus_visible(|style| {
                                        style.border_4().border_color(gpuim::rgb(0x10B981))
                                    })
                                    .on_click(cx.listener(|this, _, _, cx| {
                                        this.message =
