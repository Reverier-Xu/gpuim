...
/// Implement this trait to allow views to handle textual input when
/// implementing an editor, field, etc.
///
/// Once your view implements this trait, you can use it to construct an
/// [`ElementInputHandler<V>`]. This input handler can then be assigned during
/// paint by calling [`Window::handle_input`].
///
...
pub trait EntityInputHandler: 'static + Sized {
    ...
    fn text_for_range(
        &mut self, range: Range<usize>, adjusted_range: &mut Option<Range<usize>>,
        window: &mut Window, cx: &mut Context<Self>,
    ) -> Option<String>;

    /// See [`InputHandler::selected_text_range`] for details
    fn selected_text_range(
        &mut self, ignore_disabled_input: bool, window: &mut Window, cx: &mut Context<Self>,
    ...
    fn replace_text_in_range(
        &mut self, range: Option<Range<usize>>, text: &str, window: &mut Window,
        cx: &mut Context<Self>,
    );
    ...
    fn replace_and_mark_text_in_range(
        ...
        new_selected_range: Option<Range<usize>>, window: &mut Window, cx: &mut Context<Self>,
    );

    /// See [`InputHandler::bounds_for_range`] for details
    fn bounds_for_range(
        &mut self, range_utf16: Range<usize>, element_bounds: Bounds<Pixels>, window: &mut Window,
        cx: &mut Context<Self>,
    ) -> Option<Bounds<Pixels>>;

    /// See [`InputHandler::character_index_for_point`] for details
    fn character_index_for_point(
        &mut self, point: crate::Point<Pixels>, window: &mut Window, cx: &mut Context<Self>,
    ) -> Option<usize>;
...
/// The canonical implementation of [`crate::PlatformInputHandler`]. Call
/// [`Window::handle_input`] with an instance during your element's paint.
...
impl<V: 'static> ElementInputHandler<V> {
    /// Used in [`Element::paint`][element_paint] with the element's bounds, a
    /// `Window`, and a `App` context.
    ///
...
impl<V: EntityInputHandler> InputHandler for ElementInputHandler<V> {
    ...
    fn character_index_for_point(
        &mut self, point: crate::Point<Pixels>, window: &mut Window, cx: &mut App,
    ) -> Option<usize> {
        self.view.update(cx, |view, cx| {
