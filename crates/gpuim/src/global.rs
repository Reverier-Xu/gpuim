...
/// [`Global`] and holds the global state. Then create a newtype struct that
/// wraps the global type and create custom accessor methods to expose the
/// desired subset of operations.
...
pub trait UpdateGlobal {
    /// Updates the global instance of the implementing type using the provided
    /// closure.
    ///
    /// This method provides the closure with mutable access to the context and
