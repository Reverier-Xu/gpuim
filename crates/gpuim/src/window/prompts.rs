...
impl PromptHandle {
    ...
    pub fn with_view<V: Prompt + Render>(
        self, view: Entity<V>, window: &mut Window, cx: &mut App,
...
pub fn fallback_prompt_renderer(
    level: PromptLevel, message: &str, detail: Option<&str>, actions: &[PromptButton],
    handle: PromptHandle, window: &mut Window, cx: &mut App,
) -> RenderablePromptHandle {
...
/// The default GPUI fallback for rendering prompts, when the platform doesn't
/// support it.
