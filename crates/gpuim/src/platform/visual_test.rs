//! Visual test platform that combines real rendering (macOs-only for now) with
//! controllable TestDispatcher.
//!
...
/// A platform that combines real Mac rendering with controllable
/// TestDispatcher.
///
...
/// - Advance simulated time for testing time-based behaviors (tooltips,
///   animations, etc.)
...
impl VisualTestPlatform {
    ...
    ///
    /// The seed is used for deterministic random number generation in the
    /// TestDispatcher.
    ...
    /// Returns a reference to the TestDispatcher for controlling task
    /// scheduling and time.
...
impl Platform for VisualTestPlatform {
    ...
    fn prompt_for_paths(
        &self, _options: PathPromptOptions,
    ...
    fn prompt_for_new_path(
        &self, _directory: &Path, _suggested_name: Option<&str>,
