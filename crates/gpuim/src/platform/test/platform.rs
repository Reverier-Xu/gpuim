...
impl TestPlatform {
    ...
    pub fn with_text_system(
        executor: BackgroundExecutor, foreground_executor: ForegroundExecutor,
    ...
    pub(crate) fn prompt(
        &self, msg: &str, detail: Option<&str>, answers: &[PromptButton],
...
impl Platform for TestPlatform {
    ...
    fn prompt_for_paths(
        &self, _options: crate::PathPromptOptions,
    ) -> oneshot::Receiver<Result<Option<Vec<std::path::PathBuf>>>> {
        unimplemented!()
    }

    fn prompt_for_new_path(
        &self, directory: &std::path::Path, _suggested_name: Option<&str>,
