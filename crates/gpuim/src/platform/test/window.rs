...
impl TestWindow {
    pub(crate) fn new(
        handle: AnyWindowHandle, params: WindowParams, platform: Weak<TestPlatform>,
        display: Rc<dyn PlatformDisplay>, renderer: Option<Box<dyn PlatformHeadlessRenderer>>,
    ) -> Self {
...
impl PlatformWindow for TestWindow {
    ...
    fn prompt(
        &self, _level: crate::PromptLevel, msg: &str, detail: Option<&str>,
