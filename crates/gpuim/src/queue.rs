...
impl<T> PriorityQueueReceiver<T> {
    ...
    ///
    /// This method is best suited if you only intend to pop one element, for
    /// better performance on large queues see [`Self::try_iter`]
    ///
    /// # Errors
    ///
    ...
    ///
    /// This method is best suited if you only intend to pop one element, for
    /// better performance on large queues see [`Self::iter``]
    ///
    /// # Errors
    ///
    /// If the sender was dropped
    ...
    /// this iterator will end when all elements have been consumed and will not
    /// wait for new ones.
