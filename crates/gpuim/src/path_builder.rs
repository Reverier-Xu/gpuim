...
impl PathBuilder {
    ...
    pub fn dash_array(mut self, dash_array: &[Pixels]) -> Self {
        ...
        // to yield an even number of values. Thus, 5,3,2 is equivalent to
        // 5,3,2,5,3,2.
    ...
    /// Draw a curve from the current point to the given point, using the given
    /// control point.
    #[inline]
    ...
    pub fn cubic_bezier_to(
        &mut self, to: Point<Pixels>, control_a: Point<Pixels>, control_b: Point<Pixels>,
    ) {
        self.raw
    ...
    pub fn arc_to(
        &mut self, radii: Point<Pixels>, x_rotation: Pixels, large_arc: bool, sweep: bool,
        to: Point<Pixels>,
    ) {
        self.raw.arc_to(
            radii.into(),
    ...
    fn tessellate_fill(
        path: &lyon::path::Path, options: &FillOptions,
    ...
    fn tessellate_stroke(
        dash_array: Option<Vec<Pixels>>, path: &lyon::path::Path, options: &StrokeOptions,
    ) -> Result<Path<Pixels>, Error> {
