...
use crate::{
    self as gpuim, AbsoluteLength, AlignContent, AlignItems, AlignSelf, BorderStyle, CursorStyle,
...
// gate on rust-analyzer so rust-analyzer never needs to expand this macro, it takes up to 10
// seconds to expand due to inefficiencies in rust-analyzers proc-macro srv
#[cfg_attr(
    all(any(feature = "inspector", debug_assertions), not(rust_analyzer)),
    gpuim_macros::derive_inspector_reflection
)]
pub trait Styled: Sized {
    /// Returns a reference to the style memory of this element.
    fn style(&mut self) -> &mut StyleRefinement;

    gpuim_macros::style_helpers!();
    gpuim_macros::visibility_style_methods!();
    gpuim_macros::margin_style_methods!();
    gpuim_macros::padding_style_methods!();
    gpuim_macros::position_style_methods!();
    gpuim_macros::overflow_style_methods!();
    gpuim_macros::cursor_style_methods!();
    gpuim_macros::border_style_methods!();
    gpuim_macros::box_shadow_style_methods!();
    ...
    /// Sets the truncate overflowing text with an ellipsis (…) at the end if
    /// needed. [Docs](https://tailwindcss.com/docs/text-overflow#ellipsis)
    fn text_ellipsis(mut self) -> Self {
        self.text_style().text_overflow = Some(TextOverflow::Truncate(ELLIPSIS));
        self
    }

    /// Sets the truncate overflowing text with an ellipsis (…) at the start if
    /// needed. Typically more adequate for file paths where the end is more
    /// important than the beginning. Note: This doesn't exist in Tailwind
    /// CSS.
    ...
    /// Sets the truncate to prevent text from wrapping and truncate overflowing
    /// text with an ellipsis (…) if needed. [Docs](https://tailwindcss.com/docs/text-overflow#truncate)
    ...
    /// Sets the element to allow a flex item to grow and shrink as needed,
    /// ignoring its initial size. [Docs](https://tailwindcss.com/docs/flex#flex-1)
    ...
    /// Sets the element to allow a flex item to grow and shrink, taking into
    /// account its initial size. [Docs](https://tailwindcss.com/docs/flex#auto)
    ...
    /// Sets the element to allow a flex item to shrink but not grow, taking
    /// into account its initial size. [Docs](https://tailwindcss.com/docs/flex#initial)
    ...
    /// Sets the element to allow a flex item to grow to fill any available
    /// space. [Docs](https://tailwindcss.com/docs/flex-grow)
    ...
    /// Sets the element to prevent flex items from wrapping, causing inflexible
    /// items to overflow the container if necessary. [Docs](https://tailwindcss.com/docs/flex-wrap#dont-wrap)
    fn flex_nowrap(mut self) -> Self {
        self.style().flex_wrap = Some(FlexWrap::NoWrap);
        self
    }

    /// Sets the element to align flex items to the start of the container's
    /// cross axis. [Docs](https://tailwindcss.com/docs/align-items#start)
    fn items_start(mut self) -> Self {
        self.style().align_items = Some(AlignItems::FlexStart);
        self
    }

    /// Sets the element to align flex items to the end of the container's cross
    /// axis. [Docs](https://tailwindcss.com/docs/align-items#end)
    fn items_end(mut self) -> Self {
        self.style().align_items = Some(AlignItems::FlexEnd);
        self
    }

    /// Sets the element to align flex items along the center of the container's
    /// cross axis. [Docs](https://tailwindcss.com/docs/align-items#center)
    fn items_center(mut self) -> Self {
        self.style().align_items = Some(AlignItems::Center);
        self
    }

    /// Sets the element to align flex items along the baseline of the
    /// container's cross axis. [Docs](https://tailwindcss.com/docs/align-items#baseline)
    fn items_baseline(mut self) -> Self {
        self.style().align_items = Some(AlignItems::Baseline);
        self
    }

    /// Sets the element to stretch flex items to fill the available space along
    /// the container's cross axis. [Docs](https://tailwindcss.com/docs/align-items#stretch)
    fn items_stretch(mut self) -> Self {
        self.style().align_items = Some(AlignItems::Stretch);
        self
    }

    /// Sets how this specific element is aligned along the container's cross
    /// axis. [Docs](https://tailwindcss.com/docs/align-self#start)
    fn self_start(mut self) -> Self {
        self.style().align_self = Some(AlignSelf::Start);
        self
    }

    /// Sets this element to align against the end of the container's cross
    /// axis. [Docs](https://tailwindcss.com/docs/align-self#end)
    fn self_end(mut self) -> Self {
        self.style().align_self = Some(AlignSelf::End);
        self
    }

    /// Sets this element to align against the start of the container's cross
    /// axis. [Docs](https://tailwindcss.com/docs/align-self#start)
    ...
    /// Sets this element to align along the center of the container's cross
    /// axis. [Docs](https://tailwindcss.com/docs/align-self#center)
    fn self_center(mut self) -> Self {
        self.style().align_self = Some(AlignSelf::Center);
        self
    }

    /// Sets this element to align along the baseline of the container's cross
    /// axis. [Docs](https://tailwindcss.com/docs/align-self#baseline)
    fn self_baseline(mut self) -> Self {
        self.style().align_self = Some(AlignSelf::Baseline);
        self
    }

    /// Sets this element to stretch to fill the available space along the
    /// container's cross axis. [Docs](https://tailwindcss.com/docs/align-self#stretch)
    fn self_stretch(mut self) -> Self {
        self.style().align_self = Some(AlignSelf::Stretch);
        self
    }

    /// Sets the element to justify flex items against the start of the
    /// container's main axis. [Docs](https://tailwindcss.com/docs/justify-content#start)
    fn justify_start(mut self) -> Self {
        self.style().justify_content = Some(JustifyContent::Start);
        self
    }

    /// Sets the element to justify flex items against the end of the
    /// container's main axis. [Docs](https://tailwindcss.com/docs/justify-content#end)
    fn justify_end(mut self) -> Self {
        self.style().justify_content = Some(JustifyContent::End);
        self
    }

    /// Sets the element to justify flex items along the center of the
    /// container's main axis. [Docs](https://tailwindcss.com/docs/justify-content#center)
    ...
    /// Sets the element to pack content items in their default position as if
    /// no align-content value was set. [Docs](https://tailwindcss.com/docs/align-content#normal)
    fn content_normal(mut self) -> Self {
        self.style().align_content = None;
        self
    }

    /// Sets the element to pack content items in the center of the container's
    /// cross axis. [Docs](https://tailwindcss.com/docs/align-content#center)
    fn content_center(mut self) -> Self {
        self.style().align_content = Some(AlignContent::Center);
        self
    }

    /// Sets the element to pack content items against the start of the
    /// container's cross axis. [Docs](https://tailwindcss.com/docs/align-content#start)
    fn content_start(mut self) -> Self {
        self.style().align_content = Some(AlignContent::FlexStart);
        self
    }

    /// Sets the element to pack content items against the end of the
    /// container's cross axis. [Docs](https://tailwindcss.com/docs/align-content#end)
    ...
    /// Sets the element to allow content items to fill the available space
    /// along the container's cross axis. [Docs](https://tailwindcss.com/docs/align-content#stretch)
    ...
    /// Returns a mutable reference to the text style that has been configured
    /// on this element.
    ...
    /// Unlike grid_cols, it won't shrink to width 0 in
    /// AvailableSpace::MinContent constraints.
    ...
    /// Sets the grid columns with max-content maximum sizing for content-based
    /// column widths.
