...
impl Element for &'static str {
    ...
    fn prepaint(
        &mut self, _id: Option<&GlobalElementId>, _inspector_id: Option<&InspectorElementId>,
        bounds: Bounds<Pixels>, text_layout: &mut Self::RequestLayoutState, _window: &mut Window,
        _cx: &mut App,
    ) {
    ...
    fn paint(
        &mut self, _id: Option<&GlobalElementId>, _inspector_id: Option<&InspectorElementId>,
        _bounds: Bounds<Pixels>, text_layout: &mut TextLayout, _: &mut (), window: &mut Window,
        cx: &mut App,
    ) {
...
impl Element for SharedString {
    ...
    fn paint(
        &mut self, _id: Option<&GlobalElementId>, _inspector_id: Option<&InspectorElementId>,
        _bounds: Bounds<Pixels>, text_layout: &mut Self::RequestLayoutState,
...
/// For text with a uniform style, you can usually avoid calling this
/// constructor and just pass text directly.
...
impl StyledText {
    ...
    /// Get the layout for this element. This can be used to map indices to
    ...
    pub fn with_default_highlights(
        mut self, default_style: &TextStyle,
    ...
    pub fn with_highlights(
        mut self, highlights: impl IntoIterator<Item = (Range<usize>, HighlightStyle)>,
    ) -> Self {
        debug_assert!(
            self.runs.is_none(),
    ...
    fn compute_runs(
        text: &str, default_style: &TextStyle,
        highlights: impl IntoIterator<Item = (Range<usize>, HighlightStyle)>,
    ) -> Vec<TextRun> {
    ...
    fn apply_font_family_overrides(
        runs: &mut [TextRun], overrides: &[(Range<usize>, SharedString)],
    ) {
...
impl Element for StyledText {
    ...
    fn prepaint(
        &mut self, _id: Option<&GlobalElementId>, _inspector_id: Option<&InspectorElementId>,
        bounds: Bounds<Pixels>, _: &mut Self::RequestLayoutState, _window: &mut Window,
        _cx: &mut App,
    ) {
    ...
    fn paint(
        &mut self, _id: Option<&GlobalElementId>, _inspector_id: Option<&InspectorElementId>,
        _bounds: Bounds<Pixels>, _: &mut Self::RequestLayoutState, _: &mut Self::PrepaintState,
        window: &mut Window, cx: &mut App,
    ) {
...
/// The Layout for TextElement. This can be used to map indices to pixels and
/// vice versa.
...
impl TextLayout {
    fn layout(
        &self, text: SharedString, runs: Option<Vec<TextRun>>, window: &mut Window, _: &mut App,
    ) -> LayoutId {
...
impl InteractiveText {
    ...
    /// on_click is called when the user clicks on one of the given ranges,
    /// passing the index of the clicked range.
    pub fn on_click(
        mut self, ranges: Vec<Range<usize>>,
    ...
    /// on_hover is called when the mouse moves over a character within the
    /// text, passing the index of the hovered character, or None if the
    /// mouse leaves the text.
    pub fn on_hover(
        mut self, listener: impl Fn(Option<usize>, MouseMoveEvent, &mut Window, &mut App) + 'static,
    ) -> Self {
        self.hover_listener = Some(Box::new(listener));
        self
    }

    /// tooltip lets you specify a tooltip for a given character index in the
    /// string.
    pub fn tooltip(
        mut self, builder: impl Fn(usize, &mut Window, &mut App) -> Option<AnyView> + 'static,
    ) -> Self {
...
impl Element for InteractiveText {
    ...
    fn request_layout(
        &mut self, _id: Option<&GlobalElementId>, inspector_id: Option<&InspectorElementId>,
        window: &mut Window, cx: &mut App,
    ) -> (LayoutId, Self::RequestLayoutState) {
    ...
    fn paint(
        &mut self, global_id: Option<&GlobalElementId>, inspector_id: Option<&InspectorElementId>,
        bounds: Bounds<Pixels>, _: &mut Self::RequestLayoutState, hitbox: &mut Hitbox,
        window: &mut Window, cx: &mut App,
    ) {
