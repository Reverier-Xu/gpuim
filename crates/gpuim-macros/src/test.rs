...
fn generate_test_function(
    args: Args, inner_fn: ItemFn, inner_fn_attributes: Vec<syn::Attribute>, inner_fn_name: Ident,
    outer_fn_name: Ident,
                ...
                if let Type::Path(ty) = &*arg.ty {
                    ...
                    match last_segment.map(|s| s.ident.to_string()).as_deref() {
                        ...
                        Some("BackgroundExecutor") => {
                            inner_fn_args.extend(quote!(gpuim::BackgroundExecutor::new(
            ...
            fn #outer_fn_name() {
                ...
                gpuim::run_test(
                    ...
                    &mut |dispatcher, _seed| {
                        ...
                        #cx_vars
                        gpuim::ForegroundExecutor::new(exec.clone()).block_test(#inner_fn_name(#inner_fn_args));
                        drop(exec);
                        #cx_teardowns
