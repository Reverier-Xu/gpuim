...
// takes up to 10 seconds to expand due to inefficiencies in rust-analyzers
// proc-macro srv
#[cfg_attr(not(rust_analyzer), gpuim_macros::derive_inspector_reflection)]
...
fn test_derive_inspector_reflection() {
    ...
    // Get all methods that match the pattern fn(self) -> Self or fn(mut self) ->
    // Self
