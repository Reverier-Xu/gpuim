...
pub trait HttpRequestExt {
    ...
    /// Conditionally unwrap and modify self with the given closure, if the
    /// given option is Some.
...
pub trait HttpClient: 'static + Send + Sync {
    ...
    fn send(
        &self, req: http::Request<AsyncBody>,
    ) -> BoxFuture<'static, anyhow::Result<Response<AsyncBody>>>;

    fn get(
        &self, uri: &str, body: AsyncBody, follow_redirects: bool,
    ) -> BoxFuture<'static, anyhow::Result<Response<AsyncBody>>> {
...
impl HttpClientWithUrl {
    ...
    pub fn new(
        client: Arc<dyn HttpClient>, base_url: impl Into<String>, proxy_url: Option<String>,
    ) -> Self {
    ...
    pub fn new_url(
        client: Arc<dyn HttpClient>, base_url: impl Into<String>, proxy_url: Option<Url>,
    ) -> Self {
