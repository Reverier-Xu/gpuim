// FluentBuilder
// pub use gpuim_util::{FutureExt, Timeout, arc_cow::ArcCow};
...
/// Expands to an immediately-invoked function expression. Good for using the ?
/// operator in functions which do not return an Option or Result.
///
...
pub trait ResultExt<E> {
    ...
    /// Assert that this result should never be an error in development or
    /// tests.
...
/// Run the given function when the returned value is dropped (unless it's
/// cancelled).
#[must_use]
