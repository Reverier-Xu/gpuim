    ...
    D: Dimension<'a, T::Summary>,
{
    ...
    /// Item is None, when the list is empty, or this cursor is at the end of
    /// the list.
    #[track_caller]
    ...
    D: Dimension<'a, T::Summary>,
{
    ...
    #[instrument(skip_all)]
    fn seek_internal(
        &mut self, target: &dyn SeekTarget<'a, T::Summary, D>, bias: Bias,
...
{
    pub fn new(
        tree: &'a SumTree<T>, cx: <T::Summary as Summary>::Context<'b>, filter_node: F,
    ) -> Self {
...
trait SeekAggregate<'a, T: Item> {
    ...
    fn push_item(
        &mut self, item: &'a T, summary: &'a T::Summary, cx: <T::Summary as Summary>::Context<'_>,
    );
    fn push_tree(
        &mut self, tree: &'a SumTree<T>, summary: &'a T::Summary,
...
impl<T: Item> SeekAggregate<'_, T> for () {
    ...
    fn push_tree(
        &mut self, _: &SumTree<T>, _: &T::Summary, _: <T::Summary as Summary>::Context<'_>,
    ) {
    }
}
...
impl<T: Item> SeekAggregate<'_, T> for SliceSeekAggregate<T> {
    ...
    fn push_item(
        &mut self, item: &T, summary: &T::Summary, cx: <T::Summary as Summary>::Context<'_>,
    ) {
    ...
    fn push_tree(
        &mut self, tree: &SumTree<T>, _: &T::Summary, cx: <T::Summary as Summary>::Context<'_>,
    ) {
    ...
    D: Dimension<'a, T::Summary>,
{
    ...
    fn end_leaf(&mut self, _: <T::Summary as Summary>::Context<'_>) {}
    fn push_item(
        &mut self, _: &T, summary: &'a T::Summary, cx: <T::Summary as Summary>::Context<'_>,
    ) {
        self.0.add_summary(summary, cx);
    }
    fn push_tree(
        &mut self, _: &SumTree<T>, summary: &'a T::Summary,
        cx: <T::Summary as Summary>::Context<'_>,
    ) {
        self.0.add_summary(summary, cx);
    }
